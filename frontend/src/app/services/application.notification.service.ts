...
export class ApplicationNotificationService {
  ...
  public put(obj): Observable<any> {

    return this.http.put(`${this.configService.apiNotifManagerUrl}/api/` , obj)
      .pipe(
        tap(data => {
        }),
        catchError(this.handleError)
  ...
  public post(obj): Observable<any> {

    return this.http.post(`${this.configService.apiNotifManagerUrl}/api/profile-client` , obj)
      .pipe(
        tap(data => {
        }),
        catchError(this.handleError)
